<div class="formContainer">
    ...
    <form action="index.php?page=users&action=<?= isset($user) || isset($_SESSION['old_inputs']) && $_GET['action'] != 'new' ? 'edit&id='. $_GET['id'] : 'add' ?>" method="post" enctype="multipart/form-data">
